...
@Tag(name = "Validation", description = "Check if a ticket is a winner (read-only)")
@RestController
@RequestMapping("/api")
...
public class ValidationController {
    ...
    public ResponseEntity<CheckResponse> check(@Valid @RequestBody CheckRequest req) {
